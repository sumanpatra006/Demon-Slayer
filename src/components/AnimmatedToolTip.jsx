    ...
    {items.map((item, idx) => (
      <div
        ...
        <img
          ...
          src={item.image}
          alt={item.name}
          className="object-cover !m-0 !p-0 object-top rounded-full h-11 sm:h-14 w-11 sm:w-14 border-2 group-hover:scale-105 group-hover:z-30 border-green-500  relative transition duration-500 cursor-pointer" />
      </div>
    ))}
  </>);
};
